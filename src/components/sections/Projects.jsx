export default function Projects() {
  const projects = [
    { title: 'Warden Radar', desc: 'A sculk sensor network mapping tool.', tech: 'React, Websockets' },
    { title: 'Deepslate CMS', desc: 'Content management system built solid as rock.', tech: 'Node.js, MongoDB' },
    { title: 'Echo Tracker', desc: 'Visualizing acoustic signals in dark environments.', tech: 'D3.js, React' },
    { title: 'Ancient City UI', desc: 'A component library inspired by forgotten realms.', tech: 'Tailwind, Storybook' }
  ];
            ...
            <div key={idx} className="bg-deepslate-dark border-4 border-deepslate p-2 group hover:border-sculk-teal transition-all duration-300">
              <div className="bg-sculk-bg border-2 border-sculk-dark-teal p-6 h-full flex flex-col relative overflow-hidden">
                ...
                <div className="mt-6 pt-4 border-t-2 border-deepslate flex justify-between items-center relative z-10">
                  ...
                  <button className="px-4 py-2 bg-deepslate text-white hover:bg-warden-glow text-sm transition-colors border-b-4 border-black active:border-b-0 active:translate-y-1">
                    View
                  </button>
                </div>
              </div>
