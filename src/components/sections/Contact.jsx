    ...
    <section id="contact" className="min-h-[80vh] flex flex-col items-center justify-center p-8 py-20 relative">
      <div className="max-w-3xl w-full z-10 relative">
        ...
        <div className="bg-sculk-bg/90 border-4 border-deepslate p-8 md:p-12 shadow-2xl">
          <h2 className="text-4xl md:text-5xl text-warden-glow mb-8 text-center drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)]">Send a Message</h2>
          
          <form className="space-y-6 flex flex-col">
            <div>
              <label htmlFor="name" className="block text-xl text-sculk-teal mb-2">Engraver's Name</label>
              <input 
                type="text" 
                id="name"
            ...
            <div>
              <label htmlFor="email" className="block text-xl text-sculk-teal mb-2">Return Address</label>
              <input 
                type="email" 
                id="email"
                className="w-full bg-deepslate-dark border-2 border-deepslate p-3 text-xl text-white focus:outline-none focus:border-warden-glow transition-colors font-minecraft"
            ...
            <div>
              <label htmlFor="message" className="block text-xl text-sculk-teal mb-2">Inscription</label>
              <textarea 
                id="message"
                rows="5"
